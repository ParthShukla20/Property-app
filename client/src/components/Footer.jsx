            ...
            >
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end">
                        <li>
                            <Link to={"https://www.facebook.com/parth.shukla.9"} target='_blank'
                        ...
                        <li>
                            <Link to={"https://www.instagram.com/shukla_spartan/"} target='_blank'
                                className="text-brand-blue duration-300 hover:text-white font-heading"
                            >
                        ...
                        <li>
                            <Link to={"https://github.com/ParthShukla20/"} target='_blank'
                                className="text-brand-blue duration-300 hover:text-white font-heading"
                            >
                ...
                <p className="text-xs text-brand-blue font-heading">
                    Made by <strong>Parth Shukla</strong><br/>
                    &copy; 2024. PROPERTY SALE. All rights reserved.
                </p>
            </div>
        </footer>
    )
